...
import 'list_horizontal_highest _gold.dart';
import 'list_vertical_gold_selling_pricing.dart';
      ...
      slivers: [
        SliverToBoxAdapter(
          child: CustomBannerPricesGoldSliverCurrency(
            ...
            listHorizontal: const ListHorizontalHighestGold(),
          ),
        ),
        ...
        const ListVerticalGoldSellingPricing(),
      ],
    );
  }
}
