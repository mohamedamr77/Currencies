...
class GetHighestPurchasePriceForAllCurrencies{
 ...
 Future<List<BankModel>> get_highest_purchase_price_for_all_currencies() async {
   Map<String, dynamic> jsonData = await Api().get(
       url: "https://Bankeer.Banker-eg.live/api/highest-purchase-price-for-all-currencies");
   try {
